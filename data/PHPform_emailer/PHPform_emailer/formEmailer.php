...
//          CHANGE THE FOLLOWING INFORMATION TO SEND EMAIL FOR YOU //  
	...
	$toEmail = "msharif@dmacc.edu";		//CHANGE within the quotes. Place email address where you wish to send the form data. 
										//Use your DMACC email address for testing. 
										//Example: $toEmail = "jhgullion@dmacc.edu";		
	
	$subject = "Coffee Tree";	//CHANGE within the quotes. Place your own message.  For the assignment use "WDV101 Email Example" 

	$fromEmail = "Coffee Tree Form";		//CHANGE within the quotes.  Use your DMACC email address for testing OR
