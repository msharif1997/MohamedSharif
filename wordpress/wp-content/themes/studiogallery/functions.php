...
if ( function_exists( 'add_theme_support' ) ) { // Added in 2.9
  ...
  add_image_size('slide-image',980,380,true);

  add_image_size('home-small-image',290,180,true);

  add_image_size('home-tall-image',290,400,true);

  add_image_size('home-wide-image',450,130,true);

  add_image_size('blog-image',660,250,true);
...
class template1_search extends WP_Widget {
	...
	function template1_search() {
		...
		parent::WP_Widget(false, 'StudioGallery Search');
