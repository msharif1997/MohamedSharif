...
<tr>
  ...
  <td><input type="text" name="home_featured_text" class="ss_text" value="<?php echo stripslashes(stripslashes(get_option($shortname.'_home_featured_text','We are passionate London based designers, focused on visual and artistic design with passion for simplicity and minimalism.'))); ?>" /></td>
</tr>
<tr>
  <td>Custom logo URL:</td>
  <td><input type="text" name="custom_logo_url" class="ss_text" value="<?php echo stripslashes(stripslashes(get_option($shortname.'_custom_logo_url',''))); ?>" /><br /><small><a href="<?php bloginfo('url'); ?>/wp-admin/media-new.php" target="_blank">Upload your logo</a> (220px wide x 50px high)</small></td>
</tr>
<tr>
